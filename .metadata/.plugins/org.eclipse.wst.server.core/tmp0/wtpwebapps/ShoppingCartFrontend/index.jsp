						...
						<ul class="rslides" id="slider3">
								...
								<div class="banner-bg">
									<div class="container">
										<div class="banner-info">
											<h2>GOOD SHOES TAKE<span> YOU TO RIGHT PLACE</span></h2>
											<p>"Cinderella is proof that a new pair of shoes can change your life".
											</p>
											<a href="#">GLAMORUS</a>
										</div>
									</div>
							...
							<li>
								<div class="banner-bg">
									<div class="container">
										<div class="banner-info">
											<h2>RIGHT SHOES TAKE<span> YOU TO RIGHT PLACE</span></h2>
		...
		<div class="container">
			<div class="banner-bottom-grids">
				<div class="col-md-4 bottom-grid">
					<img src='<c:url value="resources/images/product_images/footware/9.jpg"/>' alt="" />
				...
				<div class="col-md-4 bottom-grid">
					<img src='<c:url value="resources/images/product_images/footware/8.jpg"/>' alt="" />
					<div class="bottom-grid-info">
						<a href="#">SANDEL</a>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing,
							vivamus congue nulla leo, quis imperdiet magna.
				...
				<div class="col-md-4 bottom-grid">
					<img src='<c:url value="resources/images/product_images/footware/7.jpg"/>' alt="" />
					<div class="bottom-grid-info">
						<a href="#">FLAT</a>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing,
							vivamus congue nulla leo, quis imperdiet magna.
