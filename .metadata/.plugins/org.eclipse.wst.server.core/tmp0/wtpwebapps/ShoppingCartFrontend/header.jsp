		...
		<div class="container">
			...
			<div class="header-top">
				...
				<div class="header-right">
					<ul>
						<li class="phone">+999 282 20 760</li>
			...
			<div class="top-nav">
				...
				<ul class="nav">
					...
					<li class="dropdown1"><a href="women_shopping">category</a>
						<ul class="dropdown2">
							<li><a href="women_product_category?category_name=saree">women</a></li>
							<li><a href="women_product_category?category_name=jacket">men</a></li>
							<li><a href="women_product_category?category_name=lehenga">kid</a></li>
