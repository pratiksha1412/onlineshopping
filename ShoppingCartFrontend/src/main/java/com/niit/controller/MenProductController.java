...
public class MenProductController {
	...
	String file_path = "E:/PROJECT/ShoppingCartFrontend/src/main/webapp/resources/upload_images/";
	...
	public String getAddProductDefaultForm(Model model){
		...
		return "men_add_product";
	}
	//------------------ DEFAULT WOMWN PRODUCT PAGE [ END ] ----------------------
	
	//------------------ ADD WOMEN PRODUCT [START] ----------------------------------
	@RequestMapping(value = "/men_add_product" , method = RequestMethod.GET)
	...
	@RequestMapping(value = "/men_add_product" , method = RequestMethod.POST)
	public String addMenProductAction(@ModelAttribute("productDAO") Product product,
	...
	@RequestMapping(value="/men_view_all_product", method = RequestMethod.GET)
	public String getAllProductList(Model model){
		...
		return "men_view_all_product";
	}
	
	@RequestMapping(value = "/men_update_product", method = RequestMethod.GET)
	public String getMenUpdateProductForm(Model model, HttpServletRequest request) {
