...
public class MenShoppingController {
	...
	@RequestMapping(value = "/men_shopping", method = RequestMethod.GET)
	public String getMenShoppingDefaultPage(Model model){
	...
	@RequestMapping(value = "/men_product_category", method = RequestMethod.GET)
